class RegistrationInformationsController < ApplicationController
  ...
  def index
    @registration_informations = RegistrationInformation.all
  ...
  def create
    ...
    respond_to do |format|
      if @registration_information.save
        format.html { redirect_to(@registration_information, :notice => 'Registration information was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @registration_information.update_attributes(params[:registration_information])
        format.html { redirect_to(@registration_information, :notice => 'Registration information was successfully updated.') }
        format.xml  { head :ok }
      else
